...
namespace Binner.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        protected virtual async Task<AuthenticationResponse> CreateAuthenticationLoginAsync(BinnerContext context, Data.Model.User user, UserContext userContext, bool autoSearch)
        {
